...
function _getConfig() {
  _getConfig = _asyncToGenerator(function* (opts) {
    ...
    webpackConfig.module.rule('plaintext').test(/\.(txt|text|md)$/).use('raw-loader').loader(require.resolve('@umijs/deps/compiled/raw-loader')); // css
    ...
    const enableManifest = () => {
      ...
      if (config.manifest && type === _types().BundlerConfigType.csr) {
        webpackConfig.plugin('manifest').use(require.resolve('@umijs/deps/compiled/webpack-manifest-plugin'), [_objectSpread({

...
func Setup(reg *rpc.ServiceRegistry, db *gorm.DB) (err error) {
	err = errors.Trace(db.AutoMigrate(&models.BasicInfo{}, &models.ClassBuild{}, models.User{}, models.PartyBuild{}))
	if err != nil {
		return
	}
	...
	err = reg.RegisterService(MOD_NAME, services.NewPartyService(db))
	if err != nil {
		return
	}

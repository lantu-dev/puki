...
const data: PageProps = {
    partName: '# 社 区 #',
    introduction: '简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介',
    threads: [
        {
            postTitle: '论坛帖子论坛帖子论坛帖子论坛帖子论坛帖子',
            postContent: '简介简介简介简介简介简介简介简介简介简介简介，简介简介简介简介简介，简介简介简介简介简介，简介简介简介简介简介，简介简介简介简介简介，简介简介简介简介简介.',
            commentNumber: 156,
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <Button icon={<SnippetsOutlined />} size="large" ghost>开源代码</Button>
                                </div>
                            </div>
                            <br />
                        </div>
                        <div
                            ...
                            <Button icon={<TeamOutlined />} size="large" type="link">xxxxxxxx</Button>
                            <Button icon={<UserOutlined />} size="large" type="link">xxxxxxxx</Button>
                            <Button icon={<UserAddOutlined />} size="large" type="link">xxxxxxxx</Button>
                            <Button icon={<TeamOutlined />} size="large" type="link">xxxxxxxx</Button>
                            <Button icon={<HeartOutlined />} size="large" type="link">xxxxxxxx</Button>
                            <Button icon={<TeamOutlined />} size="large" type="link">xxxxxxxx</Button>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <Title level={5}>论坛帖子论坛帖子论坛帖子论坛帖子论坛帖子论坛帖子论坛帖子论坛帖子</Title>
                                        <text>简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介简介</text>
                                        <div
                                            style={{
                                                display: "flex",
                                                flexDirection: "row",
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Button type="text" style={{ marginLeft: "188px" }}>企业介绍</Button>
                    </div>
                    <br />
                    <div
                        style={{
                    ...
                    >
                        ...
                        <Button type="text" style={{ marginLeft: "159px" }}>关于我们</Button>
                    </div>
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                        ...
                        <Button type="text" style={{ marginLeft: "159px" }}>社区</Button>
                    </div>
                </div>
